...
export function AnimeNavBar({ 
  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-[11000] pointer-events-none">
      <div className="flex justify-center pt-6 pointer-events-auto w-full px-4">
        <motion.div 
          className={cn(
            "flex items-center bg-black/50 border border-white/10 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg relative max-w-7xl",
            leftContent || rightContent ? "justify-between w-full md:w-auto md:min-w-[60%] px-4" : "justify-center gap-3 px-2 py-2"
          )}
                  ...
                  >
                    <div className="relative w-12 h-12">
                      ...
                      >
                        ...
                        />
                        <motion.div 
                          className="absolute w-2 h-1.5 bg-zinc-400 rounded-full"
                          animate={{
